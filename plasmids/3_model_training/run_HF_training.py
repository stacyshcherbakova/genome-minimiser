...
from modified_training import *
from extras import *
plt.style.use('ggplot')
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

folder = "1_train_on_HF_embeddings/"
...
min_beta = 0.1
max_beta = 1.0
gamma_gene_abundance_start = 0.01
gamma_gene_abundance_end = 0.1
gamma_genome_size_start = 2.0
gamma_genome_size_end = 0.1
n_epochs = 10000
max_norm = 1.0 
lambda_l1 = 0.01
...
#     scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size=20, gamma=0.5)
#     modified_train_cyclic_KL_annealing_additional_loss_SCALED(model=model, optimizer=optimizer, scheduler=scheduler, n_epochs=n_epochs, train_loader=train_loader, val_loader=val_loader, min_beta=min_beta, max_beta=max_beta, gamma_start=gamma_start, decay_rate=decay_rate, max_norm=max_norm, lambda_l1=lambda_l1)
#     print("--------------------------------------------------------------------------------------")